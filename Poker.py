...
class Baraja(metaclass=MetaClass): ## Inheritance C! metaclass of a derived class must be a (non-strict) subclass of the metaclasses of all its bases
	...
	def __init__(self, *args, **kw):
		...
		#self.mano = [(12,'T'),(12,'R'),(12,'P'),(5,'P'),(5,'R')]
